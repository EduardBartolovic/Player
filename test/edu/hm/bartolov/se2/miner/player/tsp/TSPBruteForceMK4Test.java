 ...
 * @author Edo
 */
public class TSPBruteForceMK4Test {
    
    public TSPBruteForceMK4Test() {
    }
    @Test
    public void testGetRouteSimple() {
        ...
        final TSPBruteForceMK4 SUT = new TSPBruteForceMK4(new Position(0,0,0),new Position(7,7,0),input);
        // act
    ...
    public void testGetRoute13MushRandom2188Perfect() {
        final List<Position> want = new ArrayList<>(12);
