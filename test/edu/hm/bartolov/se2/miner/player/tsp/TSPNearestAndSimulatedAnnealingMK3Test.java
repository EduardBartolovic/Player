 ...
 * @author Edo
 */
public class TSPNearestAndSimulatedAnnealingMK3Test {
    
    public TSPNearestAndSimulatedAnnealingMK3Test() {
    }
    ...
    public void testGetRouteSimple() {
        ...
        final TSPNearestAndSimulatedAnnealingMK3 SUT = new TSPNearestAndSimulatedAnnealingMK3(new Position(0,0,0),new Position(7,7,0),input);
        // act
